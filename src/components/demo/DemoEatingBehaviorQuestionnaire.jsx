...
export function DemoEatingBehaviorQuestionnaire({ prevStep, onComplete }) {
        ...
        <div className="questionnaire-container">
            ...
            <div className="questions-scroll-area">
                {currentQuestions.map((q) => (
                    <div key={q.id} className={`question-card ${errors.includes(q.id) ? 'error' : ''}`}>
                ...
                <div className="demo-modal-overlay" onClick={onComplete}>
                    <div className="demo-modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="demo-modal-body">
                            ...
                            <p className="modal-text">
                                Has completado el cuestionario de Conducta Alimentaria.
                            </p>

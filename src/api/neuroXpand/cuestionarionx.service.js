...
export async function getCuestionariosPorSeccionApi(token, idSeccion) {
  try {
    const url = `${BASE_API_NX}/cuestionario/cuestionario/obtenerCuestionarioPorSeccionId/${idSeccion}/`;
    const params = {
      headers: {
...
export async function getPreguntasCuestionarioApi(token, idCuestionario) {
  try {
    const url = `${BASE_API_NX}/cuestionario/cuestionario/obtenerPreguntas/${idCuestionario}/`;
    const params = {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export async function getRespuestasUsuarioApi(
  token,
  idUser,
  idCuestionario,
  idParentesco,
  ...
  try {
    const url = `${BASE_API_NX}/user/usuariorespuestas/obtener/`;
    const params = {
      method: "POST",
      headers: {
...
export async function guardarRespuestasUsuarioApi(token, respuestasData) {
  try {
    const url = `${BASE_API_NX}/user/usuariorespuestas/`;
    const params = {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function modificarRespuestasUsuarioApi(
  token,
  idRespuesta,
  respuestasData,
) {
  try {
    const url = `${BASE_API_NX}/user/usuariorespuestas/${idRespuesta}/`;
    const params = {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export async function obtenerResultadosCuestionarioApi(token, respuestasJson) {
  try {
    const url = `${BASE_API_NX}/user/usuariorespuestas/especialista/`;
    const params = {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function obtenerResultadoSumatoriaApi(token, respuestasJson) {
  try {
    const url = `${BASE_API_NX}/user/usuariorespuestas/obtener-perzonalisadas/`;
    const params = {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function guardarResultadoFinalApi(
  token,
  idUsuarioRespuestas,
  resultData,
) {
  try {
    const url = `${BASE_API_NX}/user/usuariorespuestas/${idUsuarioRespuestas}/`;
    const params = {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export async function obtenerReporteApi(token, idUsuario, lang = "es") {
  try {
    const url =
      lang === "es"
        ? `${BASE_API_NX}/cuestionario/cuestionario/ReporteCuestionariosPorUsuarioES/${idUsuario}/`
        : `${BASE_API_NX}/cuestionario/cuestionario/ReporteCuestionariosPorUsuarioEN/${idUsuario}/`;
    const params = {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
...
export async function obtenerSeccionesApi(edad, token) {
  try {
    const url = `${BASE_API_NX}/cuestionario/seccion/?edad=${edad}`;
    const params = {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,

...
export function EvaluacionResiliencia() {
    const { t, i18n } = useTranslation();
    const tituloSeccion = "Escala de Resiliencia";
    ...
    return (
        <div className="evaluacion-layout">
            <div className="evaluacion-question-card">
                ...
                <h2 style={{ textAlign: 'left', marginBottom: '8px' }}>{(i18n.language?.startsWith('en') && cuestionario?.title ? cuestionario?.title : cuestionario?.titulo) || t('evaluations.mental_sub_modal_title_5', 'Escala de Resiliencia')}</h2>

...
export function EvaluacionAlcohol() {
    const { t, i18n } = useTranslation();
    const tituloSeccion = "Evaluación de Alcohol";
    ...
    return (
        <div className="evaluacion-layout">
            <div className="evaluacion-question-card">
                ...
                <h2 style={{ textAlign: 'left', marginBottom: '8px' }}>{(i18n.language?.startsWith('en') && cuestionario?.title ? cuestionario?.title : cuestionario?.titulo) || t('evaluations.mental_sub_modal_title_7', 'Evaluación de Alcohol')}</h2>

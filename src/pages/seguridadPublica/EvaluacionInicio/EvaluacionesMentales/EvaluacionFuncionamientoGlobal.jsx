...
export function EvaluacionFuncionamientoGlobal() {
    const { t, i18n } = useTranslation();
    const tituloSeccion = "Funcionamiento Global";
    ...
    return (
        <div className="evaluacion-layout">
            <div className="evaluacion-question-card">
                ...
                <h2 style={{ textAlign: 'left', marginBottom: '8px' }}>{(i18n.language?.startsWith('en') && cuestionario?.title ? cuestionario?.title : cuestionario?.titulo) || t('evaluations.mental_sub_modal_title_3', 'Funcionamiento Global')}</h2>

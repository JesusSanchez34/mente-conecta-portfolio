...
export function EvaluacionSocio() {
    ...
    const subEvaluaciones = [
        {
            title: t('evaluations.socio_sub_title', 'SOCIODEMOGRÁFICOS'),
            modalTitle: t('evaluations.socio_sub_modal_title', 'Sociodemográficos'),
            description: t('evaluations.socio_sub_desc', 'En esta sección contestará preguntas básicas, que nos ayudará a conocerlo, como datos sobre su origen, género, estatura etc. Es importante señalar que su nombre será decodificado con una clave numérica, para mantener siempre su anonimato e información protegida.'),
    ...
    return (
        <div className="evaluacion-layout">
            <div className="evaluacion-question-card">
                ...
                <h2>{t('evaluations.sociodemographic_title', 'Evaluación Sociodemográfica')}</h2>

...
export function EvaluacionDeterminantesSociales() {
    const { t, i18n } = useTranslation();
    const tituloSeccion = "Determinantes Sociales";
    const tituloSeccionApi = "Determinantes Sociales";
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                // 4 is Determinantes Sociales section
                const cuestionarios = await getCuestionariosPorSeccionApi(token, 4);

                
                const foundCuestionario = cuestionarios.find(
                    c => cleanStr(c.titulo) === cleanStr(tituloSeccionApi) || 
                         cleanStr(c.titulo).includes("determinante")
                ) || cuestionarios[0];
        ...
        return (
            <div className="evaluacion-layout">
                <div className="evaluacion-question-card text-center" style={{ padding: '50px' }}>
                    ...
                    <button className="btn-regresar" onClick={() => navigate('/seguridad/evaluacion-determinantes')}>
    ...
    return (
        <div className="evaluacion-layout">
            <div className="evaluacion-question-card">
                ...
                <h2 style={{ textAlign: 'left', marginBottom: '8px' }}>{(i18n.language?.startsWith('en') && cuestionario?.title ? cuestionario?.title : cuestionario?.titulo) || t('evaluations.determinants_sub_modal_title', 'Determinantes Sociales')}</h2>
                     ...
                     <div className="mental-modal-content" onClick={(e) => e.stopPropagation()}>
                          ...
                          <div className="mental-modal-body">
                              ...
                              <div className="exit-modal-footer">
                                  ...
                                  <button className="exit-modal-btn-exit" onClick={() => navigate('/seguridad/evaluacion-determinantes')}>

...
export function EvaluacionCalidadSueno() {
    const { t, i18n } = useTranslation();
    const tituloSeccion = "Calidad del Sueño";
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                // 3 is Salud Fisica section
                const cuestionarios = await getCuestionariosPorSeccionApi(token, 3);

                console.log("Token:", token);

                console.log("Target Section Title:", tituloSeccion);
                console.log("Target Section Title (normalized):", normalize(tituloSeccion));
                if (cuestionarios && Array.isArray(cuestionarios)) {
                    cuestionarios.forEach(c => {
                        console.log(`- Candidate: "${c.titulo}" | Normalized: "${normalize(c.titulo)}" | Matches:`, normalize(c.titulo) === normalize(tituloSeccion));
                    });
                }
    ...
    const executeSubmit = async () => {
        ...
        try {
            ...
            if (payload.estatus_finalizado === 1 && cuestionario.genera_resultados === 1) {
                ...
                navigate('/seguridad/evaluacion-fisica');
            }
        ...
        return (
            <div className="evaluacion-layout">
                <div className="evaluacion-question-card text-center" style={{ padding: '50px' }}>
                    ...
                    <button className="btn-regresar" onClick={() => navigate('/seguridad/evaluacion-fisica')}>
    ...
    return (
        <div className="evaluacion-layout">
            <div className="evaluacion-question-card">
                ...
                <h2 style={{ textAlign: 'left', marginBottom: '8px' }}>{(i18n.language?.startsWith('en') && cuestionario?.title ? cuestionario?.title : cuestionario?.titulo) || t('evaluations.physical_sub_modal_title_2', 'Calidad de Sueño')}</h2>
                    ...
                    <div className="mental-modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="mental-modal-body">
                            ...
                            <div className="exit-modal-footer">
                                ...
                                <button className="exit-modal-btn-exit" onClick={() => navigate('/seguridad/evaluacion-fisica')}>

...
export function EvaluacionEstadoGeneral() {
    const { t, i18n } = useTranslation();
    const tituloSeccion = "Estado General";
    ...
    return (
        <div className="evaluacion-layout">
            <div className="evaluacion-question-card">
                ...
                <h2 style={{ textAlign: 'left', marginBottom: '8px' }}>{(i18n.language?.startsWith('en') && cuestionario?.title ? cuestionario?.title : cuestionario?.titulo) || t('evaluations.physical_sub_modal_title_1', 'Estado General')}</h2>

...
export function EvaluacionSaludGlobal() {
    const { t, i18n } = useTranslation();
    const tituloSeccion = "Salud Global";
    ...
    return (
        <div className="evaluacion-layout">
            <div className="evaluacion-question-card">
                ...
                <h2 style={{ textAlign: 'left', marginBottom: '8px' }}>{(i18n.language?.startsWith('en') && cuestionario?.title ? cuestionario?.title : cuestionario?.titulo) || t('evaluations.physical_sub_modal_title_4', 'Salud Global')}</h2>

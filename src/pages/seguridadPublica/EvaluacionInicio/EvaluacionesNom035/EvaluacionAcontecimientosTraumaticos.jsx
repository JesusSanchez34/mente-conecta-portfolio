...
export function EvaluacionAcontecimientosTraumaticos() {
    const { t } = useTranslation();
    const tituloSeccion = "IDENTIFICAR A LOS TRABAJADORES QUE FUERON SUJETOS A ACONTECIMIENTOS TRAUMATICOS SEVEROS";
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                // 7 is NOM-035 section
                const cuestionarios = await getCuestionariosPorSeccionApi(token, 7);

                
                const foundCuestionario = cuestionarios.find(
                    c => normalize(c.titulo) === normalize(tituloSeccion)
                );

                if (!foundCuestionario) {
                    throw new Error(`Cuestionario "${tituloSeccion}" no encontrado en el sistema. Encontrados: ${cuestionarios ? cuestionarios.map(c => c.titulo).join(", ") : "ninguno"}`);
                }
    ...
    const executeSubmit = async () => {
        ...
        try {
            ...
            if (payload.estatus_finalizado === 1 && cuestionario.genera_resultados === 1) {
                ...
                navigate('/seguridad/evaluacion-nom035');
            }
        ...
        return (
            <div className="evaluacion-layout">
                <div className="evaluacion-question-card text-center" style={{ padding: '50px' }}>
                    ...
                    <button className="btn-regresar" onClick={() => navigate('/seguridad/evaluacion-nom035')}>
    ...
    return (
        <div className="evaluacion-layout">
            <div className="evaluacion-question-card">
                ...
                <h2 style={{ textAlign: 'left', marginBottom: '8px' }}>{cuestionario?.titulo || 'Acontecimientos Traumáticos Severos'}</h2>
                            ...
                            <div key={pregunta.id} className="pregunta-card-item">
                                <div className="pregunta-title-row">
                                    <h4 className="pregunta-title">
                                        {questionIndex}. {pregunta.pregunta}
                                    </h4>
                                    {pregunta.explicacionPregunta && (
                                        <span 
                                            className="pregunta-help-icon"
                                            title={pregunta.explicacionPregunta}
                                            onClick={() => alert(pregunta.explicacionPregunta)}
                                        >
                                            ❓
                                        </span>
                                    )}
                                        ...
                                        return (
                                            <div key={resp.id} className="respuesta-option-wrapper">
                                                <label className={`respuesta-option-label ${isSelected ? 'selected' : ''}`}>
                                                    ...
                                                    />
                                                    <span className="respuesta-option-text">{resp.respuesta}</span>
                                                </label>
                     ...
                     <div className="mental-modal-content" onClick={(e) => e.stopPropagation()}>
                         ...
                         <div className="mental-modal-body">
                             ...
                             <div className="exit-modal-footer">
                                 ...
                                 <button className="exit-modal-btn-exit" onClick={() => navigate('/seguridad/evaluacion-nom035')}>
                ...
                <div className="mental-modal-overlay" onClick={() => setShowInstructionsModal(false)}>
                    <div className="mental-modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="mental-modal-body">
                            ...
                            <p className="mental-modal-description" style={{ whiteSpace: 'pre-line' }}>
                                {cuestionario?.instrucciones}
                            </p>

...
import { useAuth } from ".";
import {
  getDashBoardHasAlcoholEvaluationApi,
  getDashBoardHasAlzheimerRiskApi,
  getDashBoardHasColumbiaQuestionnaireApi,
  getDashBoardHasDrugsQuestionnaireApi,
  getDashBoardHasEatingBehaviorApi,
  getDashBoardHasGAD7Api,
  getDashBoardHasPhysicalActivityApi,
  getDashBoardHasPlutchickQuestionnaireApi,
  getDashBoardHasPSL5QuestionnaireApi,
  getDashBoardHasPsychiatricSymptomsApi,
  getDashBoardHasSleepQualityApi,
  getDashBoardHasTraumaticEventsApi,
  getHasPHQ9sApi,
  getHasResilienceScaleApi,
  getHasTobaccoEvaluationApi,
  getOpcionesPreguntaUsuariosApi,
} from "../api/dashboardnx.service";
